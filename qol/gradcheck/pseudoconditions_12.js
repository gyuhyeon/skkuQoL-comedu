...
var subject_section =  { "전공기반":not_selected+",기본프로그래밍,컴퓨터교육개론,자료구조,인터넷윤리,논리회로,객체지향프로그래밍,Unix입문,교육과인터넷,상업정보교과논리논술,컴퓨터교재연구및지도법", "전공심화":not_selected+",컴퓨터교과교육론,"+direct_input, "교양":not_selected+",유학사상과가치관,의사소통,창의와사유,리더십,기본영어,전문영어글로벌문화,인간문화,사회역사,자연과학기술,기초인문사회과학,기초자연과학,기타교양", "교직":not_selected+",특수교육학개론,교직실무,교육봉사활동,교육실습,"+direct_input
}; 
