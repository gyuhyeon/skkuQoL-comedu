...
$sql = "SELECT * FROM admin.qol_labreservelist WHERE studentname='$name' and password='$password';";
...
for($i=0; $i<count($todelete); ++$i){
    $sql.="DELETE FROM admin.qol_labreservelist WHERE reserve_srl=".($todelete[$i]['reserve_srl']).";";
}
