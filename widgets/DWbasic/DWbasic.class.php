<?php
    ...
    class DWbasic extends WidgetHandler {
        ...
        function proc($args) {
            ...
            // Get module information after listing module_srls if the module is not RSS
                ...
                if(!$args->module_srls){
                    ...
                    $output = executeQueryArray('widgets.DWbasic.getMids', $obj);
                    if($output->data) {
        ...
        /**
         * @brief Get a list of comments and return DWbasicItem
         **/
        function _getCommentItems($args) {
            ...
            foreach($output as $key => $oComment) {
                ...
                $content_item = new DWbasicItem($browser_title);
        ...
        function _getDocumentItems($args){
            ...
            // Get categories
            $obj->module_srl = $args->module_srl;
            $output = executeQueryArray('widgets.DWbasic.getCategories',$obj);
            ...
            $output = executeQueryArray('widgets.DWbasic.getNewestDocuments', $obj);
            ...
            if(count($output->data)) {
                ...
                for($i=0,$c=count($document_srls);$i<$c;$i++) {
                    ...
                    $content_item = new DWbasicItem( $args->module_srls_info[$module_srl]->browser_title );
        ...
        function _getRssItems($args){
            ...
            if($xml_doc->rss) {
                ...
                foreach ($items as $key => $value) {
                    ...
                    $content_item = new DWbasicItem($rss->title);
    ...
    class DWbasicItem extends Object {
        ...
        function DWbasicItem($browser_title=''){
		...
		function getVotedCount()
		{
			...
			return $voted_count>0 ? $voted_count : '';
		}
